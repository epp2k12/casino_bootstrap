...
<div class="clearfix main_content">
  ...
  <div class="col-md-8 index_main">
    ...
    <div class="row" style="padding:10px">
      ...
      <div class="panel panel-warning chef_page_tip index_panel" >
            ...
            <div class="panel-body">Enjoy our Chef's Favorite and Mastered Recipes that would delight your taste buds and send you through a nostalgia of high gastronomic satisfaction.
        ...
        <div class="panel panel-warning index_panel">
            ...
            <div class="panel-body">Fridays, Saturdays and Sundays are always a treat of delicious food. Ranging from filipino to international dishes and specialties. It is like
  ...
  <div class="col-md-4 aside_main" style="margin-right:0px">
    ...
    ?>
          <a class="btn btn-responsive" href="christmas_package.php">
    <img src="images/christmas_menu/christmas_menu_bk_home.png" class="img-responsive" style="max-width:100%;max-height:100%;background-color:#ffffff;padding:10px">
    </a>
    <?php
